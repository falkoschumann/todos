...
import { createClearCompletedCommand } from "../../src/domain/clear_completed.command";
import { createCompletedClearedEvent } from "../../src/domain/completed_cleared.event";
